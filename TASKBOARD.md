...
[codex] TEST-002 — Tests de integración relay mock PC↔relay↔cliente: estado PC offline, modelos, mensaje con modelo/session trust/permisos, aprobación y buffer de historial — Validación: pytest tests 49/49 — Commit: incluido en commit TEST-002 — Fecha: 2026-06-25 07:49
